...
### Phase 1: 画像アップロード機能（優先度：高）
1. R2ストレージへの画像アップロード機能
2. 画像プレビュー・管理機能
3. 動画アップロード機能（最大100MB）
...
1. **メインイメージ管理** - 最大3つのスライダー画像/動画
2. **こだわり情報管理** - 1〜6個のこだわりポイント
3. **ご挨拶管理** - タイトル・本文・画像の編集
4. **メニュー画像管理** - 最大50枚のメニュー画像
5. **宴会コース管理** - コース情報の追加・編集・削除
6. **新着情報管理** - お知らせの投稿・編集
7. **ギャラリー管理** - 写真ギャラリーの管理
8. **FAQ管理** - よくある質問の編集

すべての管理画面で以下の機能が利用できます：
- ✅ CRUD操作（追加・読取・更新・削除）
- ✅ ドラッグ&ドロップでの並び替え
- ✅ モーダルウィンドウでの編集
- ✅ リアルタイムプレビュー
